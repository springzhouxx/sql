...
```
The assigned article argues that databases are not merely neutral collections of numbers, they are socio-technical systems that encode specific social and political values. In the case of Pakistan’s NADRA system, the database schema enforces a traditional, patriarchal definition of family. By requiring a verified digital family tree for access to banking and healthcare, the system marginalizes those who do not fit established norms, such as orphans or the single moms. This illustrates a critical issue: when we design data structures, we are often codifying social judgments into technical requirements.
As a PhD student in Educational Policy, I see these same value systems embedded in the large-scale databases I use, specifically the Education Quality and Accountability Office (EQAO) database in Ontario. EQAO embeds a value system that prioritizes standardization and universal measurability. By focusing on standardized test scores as the primary metric for "success," the database inherently values a default student profile. This creates significant friction for students with special education needs, who are often represented in the database through "exemptions" or "accommodations." In this schema, disability is treated as an "edge case" or a deviation from the norm, rather than a natural part of student diversity.
Furthermore, my research into special education identification rates reveals a lack of systemic fairness. The EQAO database shows massive variation in identification rates across Ontario’s 72 school boards. This suggests that a student's data identity for being identified as special education needs (SEN) is often determined by geographic and administrative logic rather than their actual clinical needs. In other words, a student’s likelihood of receiving essential support is not solely dependent on their individual needs, but on the identification threshold of the specific school board they happen to attend. Much like the NADRA system, these educational databases create a "postcode lottery" where the rigid schema of the system dictates a student’s access to support and resources. Recognizing these embedded values is essential for researchers to ensure that data-driven policies do not further marginalize vulnerable student populations.
```
